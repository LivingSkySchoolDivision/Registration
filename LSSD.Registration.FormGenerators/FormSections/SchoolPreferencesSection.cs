        ...
        public static IEnumerable<OpenXmlElement> GetSection(SchoolPreferenceList SchoolPreferences) 
        {
            ...
            return new List<OpenXmlElement>() {
                TableHelper.StyledTable(                    
                    new TableRow(
                        TableHelper.LabelCell("First school choice", JustificationValues.Center, 1, 33.3),
                        TableHelper.LabelCell("Second school choice", JustificationValues.Center, 1, 33.3),
                        TableHelper.LabelCell("Third school choice", JustificationValues.Center, 1, 33.3)
                    ),
                    new TableRow(
